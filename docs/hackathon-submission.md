# LumenFi Hackathon Submission Notes
...
LumenFi is the project I am most proud of. I built a working DeFi dApp on Arc Testnet with deployed contracts for a lending pool and a stablecoin swap/liquidity pool, plus a production-style frontend. The app is designed to make Arc stablecoin activity easier to understand and use from one interface.
...
Solo builder for now, open to collaborating with other Arc builders.

## Notes

This is a testnet review build. Contracts and product flows are live on Arc Testnet, but the lending market is an MVP and not production financial infrastructure.
